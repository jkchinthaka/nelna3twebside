  ...
  return (
    <div className="mx-auto max-w-6xl space-y-10 px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {recipes.map((recipe) => (
          <article key={recipe.id} className="rounded-3xl border border-slate-100 bg-white overflow-hidden shadow-sm">
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm text-slate-600">{recipe.summary}</p>
      ...
      <section className="rounded-3xl border border-slate-100 bg-slate-50 p-8">
        <h3 className="text-lg font-semibold text-slate-900">Best Cut For...</h3>
