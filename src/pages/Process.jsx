    ...
    <div className="mx-auto max-w-6xl space-y-10 px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {processTimeline.map((step, index) => (
          <div key={step.title} className="rounded-3xl border border-nelna-green-soft bg-nelna-white overflow-hidden shadow-sm">
            ...
            <div className="p-6">
              ...
              <h3 className="mt-2 text-lg font-semibold text-nelna-dark">{step.title}</h3>
              <p className="mt-3 text-sm text-nelna-dark/80">{step.body}</p>
            </div>
          </div>
        ))}
      </div>
