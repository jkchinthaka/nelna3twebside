...
const BusinessEntity = () => {
  ...
  const colorMap = {
    ...
    green: { bg: 'bg-green-50', text: 'text-green-600', border: 'border-green-200', gradient: 'from-green-600 to-emerald-500' },
    blue: { bg: 'bg-blue-50', text: 'text-blue-600', border: 'border-blue-200', gradient: 'from-blue-600 to-cyan-500' },
    emerald: { bg: 'bg-emerald-50', text: 'text-emerald-600', border: 'border-emerald-200', gradient: 'from-emerald-600 to-teal-500' }
  };
                 ...
                 {entity.extraAction && (
                    <div className="mt-10">
                       <a 
                         ...
                         className={`inline-flex items-center gap-3 px-8 py-4 rounded-xl text-white font-bold shadow-lg shadow-emerald-200 transform hover:-translate-y-1 transition-all duration-300 bg-gradient-to-r ${theme.gradient}`}
                       >
