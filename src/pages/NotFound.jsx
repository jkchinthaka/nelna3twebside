  ...
  return (
    <div className="bg-nelna-green-soft">
      <div className="page-shell flex min-h-[68vh] flex-col items-center justify-center py-14 text-center">
        ...
        <h1 className="mt-3 text-3xl font-bold text-nelna-dark md:text-4xl">Page not found</h1>
        <p className="mt-3 max-w-xl text-sm text-nelna-dark/80 md:text-base">
        ...
        <Link
          to="/contact"
          className="inline-flex min-h-[44px] items-center justify-center rounded-pill border border-nelna-dark/25 px-6 py-3 text-sm font-semibold text-nelna-dark/90"
        >
          Contact support
        </Link>
        </div>
