...
export default function ResultCard({ store }: ResultCardProps) {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-brand-100 hover:shadow-md">
      ...
      <div className="mt-5 flex items-center justify-between gap-4">
        ...
        <a
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-slate-700 md:flex-none"
