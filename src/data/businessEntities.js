import { Factory, Sprout, Globe, Leaf } from 'lucide-react'

export const entities = [
  { 
    id: "nelna-farm",
    name: "Nelna Farm (Pvt) Ltd", 
    icon: Factory, 
    color: "bg-orange-500",
    themeColor: "orange",
  ...
  { 
    ...
    description2: `Nelna Breeders (Pvt.) Ltd. has been currently producing 600,000 day-old commercial broiler chicks every month. All chicks are subjected to thorough screening before issuing to the field in order to make sure the quality and disease-free day-old chicks. Parent flocks of 7,500 birds (including 10% Males) in each batch were reared in environmentally controlled houses.`,
     stats: [
        ...
        { label: "Parent Flocks", value: "7,500/batch" }
    ],
    imageId: "breeders"
  },
  { 
    id: "nelna-impex",
    name: "Nelna Impex (Pvt) Ltd", 
    icon: Globe, 
    color: "bg-blue-500", 
    themeColor: "blue",
    ...
    highlight: "Eco-Friendly Innovation (PPP Project)",
     stats: [
        ...
        { label: "Products", value: "PPP (Protein)" },
        { label: "Impact", value: "Eco-Protection" }
    ],
    imageId: "impex"
  },
  { 
    ...
    extraAction: { label: "Visit Nelna Mango", url: "https://nelnamango.com", external: true },
     stats: [
        ...
        { label: "Crop", value: "Premium Mangoes" },
        { label: "Region", value: "Deep South-East" }
    ],
    imageId: "agri"
  },
];
