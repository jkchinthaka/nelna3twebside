    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-brand-800 to-brand-900 py-20">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-start gap-8 px-4 text-white md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-shrink-0 flex-wrap gap-4">
          <Link
            to="/products"
            className="rounded-full bg-white px-8 py-3 text-base font-bold text-brand-900 shadow-lg transition hover:scale-105 hover:bg-brand-50"
          >
            {t('cta.orderNow')}
          </Link>
          <Link
            to="/contact"
            className="rounded-full border-2 border-white px-8 py-3 text-base font-bold text-white transition hover:bg-white hover:text-brand-900"
          >
            {t('cta.contactUs')}
          </Link>
        </div>
