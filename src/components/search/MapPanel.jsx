        ...
        <div className="flex rounded-full bg-nelna-green-soft p-1 ring-1 ring-nelna-dark/200">
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-bold transition-all ${
              view === "map" ? "bg-nelna-white text-brand-green shadow-sm" : "text-nelna-dark/70 hover:text-nelna-dark/90"
            }`}
          >
            Map
          </button>
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-bold transition-all ${
              view === "list" ? "bg-nelna-white text-brand-green shadow-sm" : "text-nelna-dark/70 hover:text-nelna-dark/90"
            }`}
          >
            List
          </button>
        ...
        {stores.map((store) => {
          ...
          return (
            <li key={store.storeName} className="flex items-center justify-between">
              ...
              <a
                className={`font-semibold ${hasLocation ? 'text-brand-green' : 'text-nelna-white/80 cursor-not-allowed'}`}
