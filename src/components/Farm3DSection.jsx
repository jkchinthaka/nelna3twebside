...
function Farm3DSection() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-gradient-to-b from-nelna-green-soft via-nelna-white to-nelna-white py-20 md:py-24">
      <div className="pointer-events-none absolute -left-16 top-10 h-56 w-56 rounded-full bg-brand-green-200/45 blur-3xl" />
      <div className="pointer-events-none absolute -right-20 bottom-4 h-64 w-64 rounded-full bg-nelna-gold-soft blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,480px)] lg:px-8">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="inline-flex items-center rounded-full border border-brand-green-200 bg-nelna-white/80 px-4 py-1 text-xs font-bold uppercase tracking-[0.16em] text-brand-green-800">
            Premium Farm Visual Story
          </p>

          <h2 className="mt-5 text-3xl font-display font-bold leading-tight text-nelna-dark sm:text-4xl lg:text-5xl">
            Sri Lankan Freshness with
            <span className="block bg-gradient-to-r from-nelna-green via-nelna-gold to-nelna-gold bg-clip-text text-transparent">
              Modern Food Excellence
            </span>
          </h2>

          <p className="mt-5 max-w-xl text-base font-medium leading-relaxed text-nelna-dark/90 sm:text-lg">
            ...
            {[
              ...
              <article key={item.title} className="rounded-2xl border border-nelna-dark-soft bg-nelna-white/88 p-4 shadow-[0_18px_35px_-30px_rgba(37,27,37,0.45)]">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-nelna-dark">{item.title}</h3>
                    <p className="mt-1 text-xs font-medium leading-relaxed text-nelna-dark/80">{item.detail}</p>
                  </div>
                </div>
              </article>
            ))}
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-6 -z-10 rounded-[2.25rem] bg-gradient-to-br from-nelna-green/30 via-nelna-gold-soft to-nelna-green-dark/45 blur-xl" />

          <div className="overflow-hidden rounded-[2rem] border border-nelna-white/80 bg-nelna-white/90 shadow-[0_28px_56px_-30px_rgba(37,27,37,0.55)] backdrop-blur">
            {showInteractiveScene ? (
              <Suspense
                fallback={
                  <div className="flex h-[300px] items-center justify-center bg-gradient-to-br from-nelna-green-soft to-nelna-gold-soft text-sm font-semibold text-nelna-dark/90 md:h-[360px]">
            ...
            <div className="flex flex-col gap-2 border-t border-nelna-dark-soft/80 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <p className="text-xs font-medium text-nelna-dark/80">
                {showInteractiveScene
