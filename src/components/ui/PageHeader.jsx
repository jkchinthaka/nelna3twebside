  ...
  return (
    <header className={cn('mb-6 flex flex-wrap items-start justify-between gap-4', className)}>
      <div>
        ...
        <h1 className="mt-1 text-2xl font-extrabold text-nelna-dark md:text-3xl dark:text-nelna-white">{title}</h1>
        {subtitle ? <p className="mt-2 max-w-3xl text-[0.96rem] leading-relaxed text-nelna-dark/90 dark:text-nelna-white/80">{subtitle}</p> : null}
      </div>
